public static partial class RocksDbExtensions
{
    ...
    public static string Get(this RocksDbSharp.RocksDb db, Int128 key) => db.GetString(BitConverter.GetBytes(key));
    public static byte[] GetBytes(this RocksDbSharp.RocksDb db, Int128 key) => db.GetBytes(BitConverter.GetBytes(key));
